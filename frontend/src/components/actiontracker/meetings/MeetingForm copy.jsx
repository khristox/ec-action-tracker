// src/components/meetings/MeetingForm.jsx - IMPROVED with Better Recurring Meeting Handling
...
const RECURRENCE_TYPES = [
  { value: 'daily', label: 'Daily', icon: '📅', description: 'Repeats every day', intervalText: 'day(s)', getNextDate: (date, interval) => addDays(date, interval) },
  { value: 'weekly', label: 'Weekly', icon: '📆', description: 'Repeats every week on selected days', intervalText: 'week(s)', getNextDate: (date, interval) => addWeeks(date, interval) },
  { value: 'biweekly', label: 'Bi-Weekly', icon: '🔄', description: 'Repeats every two weeks', intervalText: 'week(s)', getNextDate: (date, interval) => addWeeks(date, interval * 2) },
  { value: 'monthly', label: 'Monthly', icon: '📅', description: 'Repeats every month on selected date', intervalText: 'month(s)', getNextDate: (date, interval) => addMonths(date, interval) },
  { value: 'quarterly', label: 'Quarterly', icon: '📊', description: 'Repeats every 3 months', intervalText: 'quarter(s)', getNextDate: (date, interval) => addMonths(date, interval * 3) },
  { value: 'yearly', label: 'Yearly', icon: '🎉', description: 'Repeats every year', intervalText: 'year(s)', getNextDate: (date, interval) => addMonths(date, interval * 12) }
];
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (isRecurring && recurrence) {
        ...
        console.log('📤 Sending recurring payload');
