...
const meetingSlice = createSlice({
  ...
  reducers: {
    ...
    // ADD THIS: Clear current meeting for edit form
    ...
    // ADD THIS: Set current meeting directly
...
// ADD THESE ALIAS SELECTORS for backward compatibility
...
export const { 
  clearMeetingState,
  clearCurrentMeeting,  // ADDED - For edit form
  clearMeetings,
  clearError, 
  clearSuccess,
  clearUpdateSuccess,
  ...
  clearMinutesError,
  setCurrentMeeting,    // ADDED - For manually setting current meeting
